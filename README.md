...
这篇博文是汇总篇，需要长篇介绍的部分将会在连接中继续，如果你遇到的开发问题能在我这里找到，请注意我实现的方法，而不是我怎么写的代码！因为问题解决思路大同小异，但是代码千变万化。
...
- 配置约定为主
- 整体结构尽量简单，让不熟悉的人快速上手
- 期望在现有框架下，15天左右完成整体前端WebApp项目开发，项目总值100W+

>你所看的目录结构时重构第四次的结果，前几次惨不忍睹！
