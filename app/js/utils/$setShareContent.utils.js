...
(function () {
    ...
    angular.module('smartac.page')
        .factory("$setShareContent", ['$wxGetConfig', '$sessionStorage', '$log', '$state', function ($wxGetConfig, $sessionStorage, $log, $state) {
            ...
            function getShareUrl(directToState, stateParams) {
                ...
                !directToState && (directToState = URL.defalutShareContent.directToState);

                var uri = URL.shareInfo.url;
            ...
            function setDefaultContent() {
                var _content = URL.defalutShareContent.content;
