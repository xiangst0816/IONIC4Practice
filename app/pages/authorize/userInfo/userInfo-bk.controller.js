...
(function () {
    angular.module('smartac.page')
        .controller('memberInfo2Ctrl', ['$rootScope', '$scope', '$sessionStorage',  '$http', 'verification', '$ionicLoading', 'AJAX', '$ionicToast', 'cityInfo','$updateUserInfo','$log','$ionicNavBarDelegate', function ($rootScope, $scope, $sessionStorage,  $http, verification, $ionicLoading, AJAX, $ionicToast, cityInfo,$updateUserInfo,$log,$ionicNavBarDelegate) {
