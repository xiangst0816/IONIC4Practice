...
(function () {
    angular.module('smartac.page')
        .controller('registerCtrl', ['$scope', 'verification', '$ionicLoading', '$state', '$sessionStorage', 'Countdown', '$ionicToast', '$q', '$getVerifyCode', '$addIntegral', '$getCode', '$getUrlParams', '$getUserInfo', '$register',  '$changePassword', '$log', '$timeout', '$rootScope', '$ionicModal', '$checkAuthorize','$localStorage','$zeroize', function ($scope, verification, $ionicLoading, $state, $sessionStorage, Countdown, $ionicToast, $q, $getVerifyCode, $addIntegral, $getCode, $getUrlParams, $getUserInfo, $register,  $changePassword, $log, $timeout, $rootScope, $ionicModal, $checkAuthorize,$localStorage,$zeroize) {
            ...
            $scope.submitForm = function () {
                ...
                $register(params).then(function (customerid) {
                    ...
                    if (sharedUserID && Internal.isInWeiXin && BASE.canGetIntegralFromShare) {
