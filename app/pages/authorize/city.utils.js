// /**
//  * Created by xiangsongtao on 16/3/25.
//  * city 数据库
//  */
// (function () {
//     angular.module('smartac.page')
//         .factory('cityInfo',function () {
//             //省份
...
//                 ['和平','河东', '河西', '南开', '河北', '红桥', '塘沽', '汉沽', '大港', '东丽', '西青', '津南', '北辰', '武清', '宝坻', '宁河', '静海', '蓟县'],
//                 ['黄浦','卢湾', '徐汇','长宁','静安','普陀','闸北','虹口', '杨浦', '闵行', '宝山', '嘉定', '浦东新区', '金山', '松江', '青浦', '南汇', '奉贤', '崇明'],
//                 ['万州','涪陵','渝中','大渡口','江北','沙坪坝','九龙坡','南岸','北碚','万盛','双桥','渝北','巴南','黔江','长寿','江津','合川','永川','南川','綦江','潼南','铜梁','大足','荣昌','璧山','梁平','城口','丰都','垫江','武隆','忠县','开县','云阳','奉节','巫山','巫溪','石柱','秀山','酉阳','彭水'],
...
//                 ['乌鲁木齐', '克拉玛依', '吐鲁番', '哈密', '昌吉', '博尔塔拉蒙古', '巴音郭楞蒙古', '阿克苏', '克孜勒苏柯尔克孜', '喀什', '和田', '伊犁哈萨克', '塔城', '阿勒泰', '石河子', '阿拉尔', '图木舒克', '五家渠' ],
