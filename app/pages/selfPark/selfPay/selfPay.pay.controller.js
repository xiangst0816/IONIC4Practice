...
(function () {
    angular.module('smartac.page')
        .controller('selfPayToPayCtrl',
            ['$scope', '$state', '$stateParams', '$filter', '$integralInfo', '$sessionStorage', '$getCode', '$ionicLoading', '$whenPaiedPark', '$ionicToast', '$timeout', '$q', '$ionicScrollDelegate', '$goBackWhenError', '$rootScope', '$userCouponList', '$log', '$smartPay',
                function ($scope, $state, $stateParams, $filter, $integralInfo, $sessionStorage, $getCode, $ionicLoading, $whenPaiedPark, $ionicToast, $timeout, $q, $ionicScrollDelegate, $goBackWhenError, $rootScope, $userCouponList, $log, $smartPay) {
                    ...
                    $scope.confirmToPay = function () {
                        ...
                        if (!$scope.finalPrice) {
                            ...
                            $log.warn("剩余费用使用支付接口");
                            $smartPay({
                                "shop_id": BASE.parkingID.toString(),//string 店铺id
