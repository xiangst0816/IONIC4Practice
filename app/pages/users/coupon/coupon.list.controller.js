...
(function () {
    angular.module('smartac.page')
        .controller('couponCtrl', ['$scope', 'AJAX',  '$sessionStorage', '$ionicToast', '$filter', '$ionicPopover', '$q', '$ionicLoading', '$userCouponList', function ($scope, AJAX,  $sessionStorage, $ionicToast, $filter, $ionicPopover, $q, $ionicLoading, $userCouponList) {
