...
(function () {
    angular.module('smartac.page')
        .controller('collectionCtrl', ["$scope", "$q", "$sessionStorage", 'AJAX',  '$ionicLoading', '$ionicToast', '$userCollectedShopList', '$shopCollect', '$filter', '$shopFloor', function ($scope, $q, $sessionStorage, AJAX,  $ionicLoading, $ionicToast, $userCollectedShopList, $shopCollect, $filter, $shopFloor) {
