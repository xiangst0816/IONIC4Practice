...
(function () {
     ...
     * */
        .factory("$couponList", ['AJAX',  '$q', '$ionicToast', '$filter', function (AJAX,  $q, $ionicToast, $filter) {
            return function (options) {
                ...
                var params = {
                    ...
                    "conditions": {
                        ...
                        "applicablechannel": 5,//适用渠道 1 积分商城 2活动（摇一摇，抽奖，围栏...）3奖赏引擎 4推送 5 app渠道
                        "querytype": "main",
                        "page": {
                            "index": 1,
                            "num": 10
                    ...
                    success: function (data) {
                        ...
                        if (data.code == 7001) {
                            ...
                            angular.forEach(result, function (value, index) {
                                ...
                                if (parseInt(value.valid_type_code) != 2) {
