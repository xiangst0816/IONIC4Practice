...
(function () {
    angular.module('smartac.page')
        .controller('photoIntegral', ['$rootScope', '$scope', '$ionicPopup', 'api', '$ionicLoading', '$http', '$filter', '$sessionStorage', 'AJAX', '$ionicToast', '$log', '$q', '$imgUpload', '$imgChoose', '$submitTradeImg', function ($rootScope, $scope, $ionicPopup, api, $ionicLoading, $http, $filter, $sessionStorage, AJAX, $ionicToast, $log, $q, $imgUpload, $imgChoose, $submitTradeImg) {
